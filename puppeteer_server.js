...
async function getUrlObj(region, mobile) {
    ...
    // let UrlObj = mongoConnect.retrieveUrlObj({}, 'greaterny', connectCallback); // grabs url from Mongo
...
// this was a misinformed idea - not actual urls, already formatted for mongo
